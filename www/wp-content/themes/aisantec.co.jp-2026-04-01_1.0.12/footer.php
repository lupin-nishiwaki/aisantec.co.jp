            ...
            <div class="m_box_fixed wrap">
              <div class="row">
                <div>
                  <h3>お電話でのお問い合わせ</h3>
                  <p class="no">
                    <a href="<?php echo esc_url(home_url()); ?>tel:0570-064457">0570-064457</a>
                  </p>
                ...
                <div>
                  <h3>メールでのお問い合わせ</h3>
                  <p class="btn">
                    <a href="<?php echo esc_url(home_url()); ?>https://aisantec.form.kintoneapp.com/public/a7449fb50979bebb1da3c12f01ad4a421bb463ec920490722544ff8f79e9a7b9" target="_blank">お問い合わせフォームへ</a>
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="main">
                  <dl>
                    ...
                    <dd>
                      ...
                      <dl class="sec">
                        <dt><a href="<?php echo esc_url(home_url()); ?>/ir/library/">IRライブラリ</a><i></i></dt>
                        <dd>
                          <ul>
                      ...
                      <dl class="sec">
                        <dt>
                          <!-- <a href="<?php echo esc_url(home_url()); ?>/ir/delivery/">IR情報メール配信サービス</a> -->
