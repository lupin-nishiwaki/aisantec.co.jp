    ...
    <div id="column2">
        <div class="wrapper m_box_fixed">
            <div class="column_main" id="challenge-story-archive">
                ...
                <section id="challenge-story-mv" class="">
                    <div class="frame-parent ">
                        <div class="m_box_fixed ">
                            ...
                            <img class="gradient-icon1" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/challenge-story.webp" alt="挑戦と進化のストーリー">
                ...
                <section>
                    ...
                    <div class="newsTypeController s_newsTypeController">
                        <ul class="s_eirTab">
                            <li class="activeTarget " data-eir-ctrl="0"><a href="/challenge-story/#column2">すべて</a></li>
                            <li class="activeTarget <?php if (strpos($_SERVER['REQUEST_URI'], 'category_interview') !== false) { ?>active<?php } ?>" data-eir-ctrl="1"><a href="/story_category/category_interview/#column2">インタビュー</a></li>
                            <li class="activeTarget <?php if (strpos($_SERVER['REQUEST_URI'], 'project') !== false) { ?>active<?php } ?>" data-eir-ctrl="2"><a href="/story_category/project/#column2">事業・プロジェクト</a></li>
                            <li class="activeTarget <?php if (strpos($_SERVER['REQUEST_URI'], 'development') !== false) { ?>active<?php } ?>" data-eir-ctrl="3"><a href="/story_category/development/#column2">技術開発・研究</a></li>
                        </ul>
                    </div>
