...
<div id="page_ir">
  ...
  <?php //mv 
  ?>
  <section id="index_main-img" class="js_anim_scroll--">
    <div class="wrapper">
      <img class="logo --01" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --02" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --03" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --04" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --05" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --06" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --07" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">
      <img class="logo --08" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-logo.svg" alt="">


      <img class="text-01 --01 active" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-01.svg" alt="">
      <img class="text-01 --01-02 active" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-01.svg" alt="">
      <img class="text-01 --02" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-01.svg" alt="">
      <img class="text-01 --03" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-01.svg" alt="">
      <img class="text-01 --04" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-01.svg" alt="">

      <img class="text-02 --01" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-02.svg" alt="">
      <img class="text-02 --02" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-02.svg" alt="">
      <img class="text-02 --03" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-02.svg" alt="">
      <img class="text-02 --04" src="/wp-content/themes/aisantec.co.jp/asset/img/ir/main-img-text-02.svg" alt="">
    </div>
  </section>
  <script>
  ...
  <?php if ($the_query->have_posts()): ?>
    <?php while ($the_query->have_posts()): ?>
      ...
      <?php if (have_rows('important_a') || have_rows('important_b')): ?>
        <section id="index_essential" class="js_anim_scroll--">
  ...
  <section id="index_pickup">
    <div class="m_box_fixed">
      <h2 class="m_txt_h2-icon js_anim_scroll">
        <img src="/wp-content/themes/aisantec.co.jp/asset/img/ir/pickup_h2.svg" alt="ピックアップ">ピックアップ
      </h2>
          ...
          <div class="wrap">
            <div class="inner">
              ...
              <ul>
                <li>決算短信</li>
                <li>四半期報告書</li>
                <li>2022年3月期第2四半期決算補足資料</li>
              </ul>
              <p class="m_btn_main btn">
                <a href="<?php echo esc_url(home_url('/asset/doc/■■■■■■')); ?>">一括ダウンロード（ZIP）</a>
              </p>
            </div>
          </div>
        </div> -->
    ...
    <div class="m_box_fixed">
      <div class="newsbox_01">
        ...
        <h2 class="m_txt_h2-icon">
          <img src="/wp-content/themes/aisantec.co.jp/asset/img/ir/news_h2.svg" alt="IRニュース">IRニュース
        </h2>
        <a href="<?php echo esc_url(home_url()); ?>/ir/information/" class="link-type01 sp-hide">IRニュースの一覧へ</a>
        <!-- E-IR Parts -->
        ...
        <div class="w50 document">
          <div class="wrap">
            <div class="inner">
              ...
              <ul>
                <li>
                  <div class="eir" data-area-name="area_irlibraryhub_015"></div>
                </li>
                <li>
                  <div class="eir" data-area-name="area_irlibraryhub_016"></div>
                </li>
                <li>
                  <div class="eir" data-area-name="area_irlibraryhub_017"></div>
                </li>
              </ul>

              <p class="m_btn_main btn">
                <a class="eirAttrTarget_zipDownloadUrl">一括ダウンロード（ZIP）<small>（<span class="eirTarget_zipDownloadSize"></span>KB）</small> </a>
              </p>

              <a href="<?php echo esc_url(home_url()); ?>/ir/library/report-brief/" class="link-type01">決算短信・決算説明資料へ</a>
            </div>
          </div>
          <p class="m_btn_main wh btn">
  ...
  <section id="topics">
    ...
    <div class="m_box_fixed">
      ...
      <div class="topics_inner">
        ...
        <h2 class="m_txt_h2-icon js_anim_scroll">
          <img src="/wp-content/themes/aisantec.co.jp/asset/img/ir/topics_h2.svg" alt="IRニュース">トピックス
        </h2>

        <a href="<?php echo esc_url(home_url()); ?>/topics" class="link-type01 sp-hide">トピックス一覧へ</a>
        ...
        <div class="frame-parent">
          ...
          <div class="group-parent js_anim_scroll_group">
            <div class="frame-group">
              <a href="<?php echo esc_url(home_url()); ?>/ir/investors/#sec01" class="vector-parent">
              ...
              <a href="<?php echo esc_url(home_url()); ?>/ir/investors/#sec03" class="vector-group">
              ...
              <a href="<?php echo esc_url(home_url()); ?>/ir/investors/#sec09" class="vector-container">
              ...
              <a href="<?php echo esc_url(home_url()); ?>/ir/investors/#sec10" class="frame-div">
            ...
            <a href="<?php echo esc_url(home_url()); ?>/ir/investors" class="link">
      ...
      <div class="section">
        ...
        <div class="section-list-parent js_anim_scroll_group">
          ...
          <div class="link-parent">
            ...
            <p class="m_btn_main wh btn">
              <a href="/challenge-story/">すべての記事をよむ</a>
            </p>
          </div>
        </div>
