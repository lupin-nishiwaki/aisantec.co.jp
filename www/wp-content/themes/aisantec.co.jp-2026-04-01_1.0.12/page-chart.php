    ...
    <div class="wrapper m_box_fixed">
      <div class="column_main">
        ...
        <section id="chart-about" class="js_anim_scroll">
          ...
          <p class="txt">当社は、取締役会と監査役・監査役会を中心としたコーポレート・ガバナンス体制を構築しています。現在、取締役会は取締役７名で構成され、うち２名を社外取締役として選任することで取締役相互の監視機能を強化しています。また、取締役会の諮問機関として任意の諮問委員会を設置しています。監査役は、3名のうち2名を社外監査役にすることでより独立した立場からの監査を確保し経営に対する監視機能の強化を図っています。</p>
        ...
        <section id="chart-list" class="js_anim_scroll">
          ...
          <dl class="item js_accordion">
            ...
            <dd class="item-dd">
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image01.jpg" alt="加藤 淳">
                </picture>

                <div class="content-inner">
                  <p class="nunber">所有する当社の株式数 <em>71,796</em><span>株&#042;</span></p>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は販売部門、管理部門、マーケティング部門、生産部門を歴任し、豊富な経験や専門知識を持ち、取締役として経営の重要事項の決定や業務執行に対する監督など適切な役割を果たして頂けると判断しております。</dd>
              </dl>
            </dd>
          </dl>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image02.jpg" alt="細井 幹広">
                </picture>

                <div class="content-inner">
                  <p class="nunber">所有する当社の株式数 <em>6,714</em><span>株&#042;</span></p>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は研究開発部門に長年携わり、豊富な経験や専門知識を持ち、取締役として経営の重要事項の決定や業務執行に対する監督など適切な役割を果たして頂けると判断しております。
                </dd>
              </dl>
            </dd>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image03.jpg" alt="佐藤 直人">
                </picture>

                <div class="content-inner">
                  <p class="nunber">所有する当社の株式数 <em>2,074</em><span>株&#042;</span></p>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は販売部門、新規事業部門に長年携わり、豊富な経験を持ち、取締役として経営の重要事項の決定や業務執行に対する監督など適切な役割を果たして頂けると判断しております。
                </dd>
              </dl>
            </dd>
          ...
          <dl class="item js_accordion">
            <dt><span class="post">取締役</span><em class="other">中島 芳明</em> <span>Yoshiaki Nakajima</span></dt>
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image04.jpg" alt="中島 芳明">
                </picture>

                <div class="content-inner">
                  <p class="nunber">所有する当社の株式数 <em>4,874</em><span>株&#042;</span></p>

                  <dl>
                    <dt>略歴、当社における地位及び担当</dt>
                    <dd>
                      2001年 3月当社入社<br>
                      2012年 8月東日本営業本部北日本営業部部長<br>
                      2016年 4月Wing事業本部 部長<br>
                      2017年 4月測地ソリューション事業本部部長<br>
                      2017年 4月取締役測地ソリューション事業本部長<br>
                      2018年 6月エーティーラボ(株)取締役（現任）<br>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は測量士の資格を有するとともに、販売部門、企画部門に長年携わり、豊富な経験を持ち、取締役として経営の重要事項の決定や業務執行に対する監督など適切な役割を果たして頂けると判断しております。
                </dd>
              </dl>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image05.jpg" alt="曽我 泰典">
                </picture>

                <div class="content-inner">
                  <p class="nunber">所有する当社の株式数 <em>10,000</em><span>株&#042;</span></p>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は販売部門、管理部門に長年携わり、豊富な経験や専門知識を持ち、取締役として経営の重要事項の決定や業務執行に対する監督など適切な役割を果たして頂けると判断しております。
                </dd>
              </dl>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image06.jpg" alt="久野 誠一">
                </picture>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は、過去に会社経営に関与したことはありませんが、あずさ監査法人に在籍し、会計監査人として当社を担当しておりました。公認会計士として高度な見識を有しており、当社経営および取締役会実効性の一層の向上に活かして頂けると判断しております。
                </dd>
              </dl>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image07.jpg" alt="梅田 靖">
                </picture>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は会社の経営に関与した経験はありませんが、富士通Japanで営業部門に長年携わり、豊富な経験や専門知識を持ち、大所高所の視点から当社の経営に有用な意見が期待できるものと判断しております。
                </dd>
              </dl>
          ...
          <dl class="item js_accordion">
            <dt><span class="post">監査役（常勤）</span></span><em class="other">野呂 充</em> <span>Mitsuru Noro</span></dt>
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image08.jpg" alt="野呂 充">
                </picture>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は長年販売部門、企画部門に携わり、豊富な経験を持ち、取締役として経営の重要事項の決定や業務執行に関わってきました。これらの経験や高い見識を当社の監査に反映して頂けると判断しております。
                </dd>
          ...
          <dl class="item js_accordion">
            <dt><span class="post">監査役<span class="tag">社外・独立</span></span><em class="other">村橋 泰志</em> <span>Hiroshi Murahashi</span></dt>
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image09.jpg" alt="村橋 泰志">
                </picture>
                ...
                <div class="content-inner">
                  ...
                  <dl>
                    <dt>略歴、当社における地位及び担当</dt>
                    <dd>
                      1969年 4月名古屋弁護士会弁護士登録<br>
                      1973年 7月村橋法律事務所開設<br>
                      1996年 5月あゆの風法律事務所に名称変更<br>
                      2004年 6月当社監査役(現任)

                      <div>
                        <p>重要な兼職の状況</p>
                        あゆの風法律事務所所長弁護士、<br>ダイコク電機株式会社社外監査役、<br>
                        ゼネラルパッカー株式会社社外取締役（監査等委員）、<br>
                        株式会社アオキスーパー社外取締役
                      </div>
                    </dd>
                  </dl>
              ...
              <dl class="box">
                <dt>選任理由</dt>
                <dd>同氏は、過去に社外役員となること以外の方法で会社経営に関与したことはありませんが、弁護士として法令や定款の遵守に係る見地から意見を述べ、取締役会及び監査役会の意思決定の妥当性・適正性を確保するための助言・提言を行っていただいております。また同氏は他社の社外監査役、社外取締役も歴任し、今後もこれらの経験や高い見識を当社の監査に反映していただけると考えております。
                </dd>
              </dl>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-image10.jpg" alt="中垣 堅吾">
                </picture>
          ...
          <p class="note">&#042;なお各氏の所有する当社の株式数は2021年9月30日現在の株数となります。</p>
        </section>
        <!-- /#chart-list -->
        ...
        <section id="chart-skill" class="js_anim_scroll">
          ...
          <div class="table-cover m_box_table">
            ...
            <div class="inner-wrap">
              <div class="inner">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-skill-image01.jpg" alt="">
                </picture>
              </div>
            </div>
        ...
        <section id="chart-organization" class="js_anim_scroll">
          ...
          <div class="table-cover m_box_table">
            ...
            <div class="inner-wrap">
              <div class="inner">
                <picture>
                  <img src="/wp-content/themes/aisantec.co.jp/asset/img/company/chart/chart-skill-image02.png" alt="">
                </picture>
              </div>
            </div>
