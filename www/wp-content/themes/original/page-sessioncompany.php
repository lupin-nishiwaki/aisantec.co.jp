          ...
          <?php while( $the_query->have_posts() ): ?>
            ...
            <section id="sessioncompany" class="js_anim_scroll">
              <div class="yearController">
                <select><option value="">2022年3月期</option></select>
              </div>

              <div class="contents-container">
                <?php if( have_rows('settlement_contents03') ): ?>
                  <?php while ( have_rows('settlement_contents03') ): ?>
                    <?php the_row();?>

                    <div class="contents-wrap">
                      <h2 class="m_txt_h2"><?php the_sub_field( 'heading02' ); ?></h2>
                        ...
                        <ul>
                          <?php if( have_rows('settlement_contents04') ): ?>
                            <?php while ( have_rows('settlement_contents04') ) : the_row();?>
                              ...
                              <li>
                                <?php $select = get_sub_field('select_c'); ?>
                                <?php if( $select == 'select01' ): ?>
                                  <?php //値（Value）が「select01」だったら ?>

                                  <?php $pdf02 = get_sub_field('pdf04'); ?>
                                  <?php if ($pdf02): ?>
                                    <a href="<?php echo $pdf02['url']; ?>" target="_blank" class="pdf-link">
                                      ...
                                      <div class="text">
                                        ...
                                        <span class="pdf">
                                          ...
                                          <span class="kb">(<?php the_sub_field( 'pdf03' ); ?>KB)</span>
                                        </span>
                                      </div>
                                    </a>
                                  <?php endif; ?>
                                ...
                                <?php elseif( $select == 'select02') : ?>
                                  <div href="" target="_blank" class="youtube-link">
                                    ...
                                    <div class="text youtube">
                                      ...
                                      <div class="youtube-wrap"><?php the_sub_field( 'youtube02' ); ?></div>
                                    </div>
                                  </div>
