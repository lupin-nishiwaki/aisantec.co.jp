...
<head>
  ...
  <?php
    ...
    $ir_pages = [
      'capital-costs-stock-prices','dx-strategy','message','plan','vision',
      'business','sustainability','disclosure','policy','director','reward',
      'owned','management-risk','system','talk','information-all','settlement',
      'ducument','news','report-brief','report-securities','report',
      'highligh-linking','segment-single','segment-segment','memo','meeting',
      'return','procedure','calender','faq','announcement','delivery','status',
      'sessioncompany','sessionsettlement','human-management','investors','business-model'
    ];
    $company_pages = [
      'company-message','outline','chart','hub','group','history',
      'reconstruction','behavioral','protection'
    ];
    $title = '';

    if (is_page('ir')) {
      $title = 'IR・会社情報｜{$site_name}';

    } elseif (is_page($ir_pages)) {
      $title = get_the_title() . ' - IR情報｜{$site_name}';

    } elseif (is_page('company')) {
      $title = '会社情報｜{$site_name}';

    } elseif (is_page($company_pages)) {
      $title = get_the_title() . ' - 会社情報｜{$site_name}';

    } elseif (is_post_type_archive('challenge-story') || is_tax('story_category')) {
      $title = '挑戦と進化のストーリー｜{$site_name}';

    } elseif (is_post_type_archive('topics') || is_tax('topics_category')) {
      $title = 'トピックス一覧｜{$site_name}';

    } elseif (is_post_type_archive('information')) {
      $title = 'ニュース一覧｜{$site_name}';
    ...
    // ディスクリプションの分岐
    $default_desc = '経営情報・財務情報・決算適時開示情報など、株主・投資家向け情報を掲載しています。';
    $desc_map = [
      'company' => 'アイサンテクノロジー株式会社の会社情報を掲載しています。',
      'company-message' => 'アイサンテクノロジー株式会社 代表取締役社長 加藤 淳からのメッセージです。',
      'outline' => '資本金、本社所在地など、アイサンテクノロジーの概要をご紹介します。',
      'chart' => 'アイサンテクノロジーの取締役、監査役の一覧と組織図をご紹介します。',
      'hub' => 'アイサンテクノロジーの拠点一覧をご紹介します。',
      'group' => 'アイサンテクノロジーのグループ会社をご紹介します。',
      'history' => 'アイサンテクノロジーの沿革をご紹介します。',
      'reconstruction' => 'アイサンテクノロジーの災害復興への取り組みをご紹介します。',
      'behavioral' => 'アイサンテクノロジーは当社コンプライアンス行動指針に基づきCSRに取り組んでまいります。',
      'protection' => 'アイサンテクノロジーはソフトウェアライセンス製品の著作権保護方針情報を掲載しています。',
      'status' => 'アイサンテクノロジーの株式について情報を掲載しています。',
    ];
    ...
    if (is_home()) {
      ...
      if (isset($desc_map[$slug])) { $description = $desc_map[$slug]; }
    }
  ?>
  ...
  <meta property="og:site_name" content="アイサンテクノロジー株式会社">
  ...
  <link rel="stylesheet" href="/asset/css/style.css?<?php echo date('YmdHi'); ?>">
  <link rel="stylesheet" href="/asset/css/maintenance.css">

  <script src="/asset/js/vender.js"></script>
  <script src="/asset/js/eir_v5.js"></script>
...
<body data-barba="wrapper" <?php body_class(); ?>>
  ...
  <div id="l_animation">
    <div class="load js_load">
      ...
      <div class="item"></div>
      <div class="item"></div>
      <div class="logo"><img src="/asset/img/logo_wh.svg" alt="アイサンテクノロジー株式会社"></div>
    </div>
  </div>
  <!-- #l_animation -->
      ...
      <ul class="gnav js_sitemap_acc">
        ...
        <li>
          <dl class="mega-menu js_mega-menu">
            <dt><a href="/ir/">IR情報</a><i></i></dt>
            <dd>
              <div class="wrap">
                <div class="heading">
                  <h3>IR・投資家情報</h3>
                  <p class="top"><a href="/ir/">IR・投資家情報トップ</a></p>
                </div>
                ...
                <div class="row">
                  ...
                  <div>
                    <dl class="sec">
                      ...
                      <dt><a href="/challenge-story/">挑戦と進化のストーリー</a><i></i></dt>
                      <dt><a href="/ir/information/">IRニュース一覧</a><i></i></dt>
        ...
        <li>
          <dl class="mega-menu js_mega-menu">
            <dt><a href="/company/">企業情報</a><i></i></dt>
            <dd>
              <div class="wrap">
                <div class="heading">
                  <h3>企業情報</h3>
                  <p class="top"><a href="/company/">企業情報トップ</a></p>
                </div>

                <ul class="sec">
                  <li><a href="/company/company-message/">トップメッセージ</a></li>
                  <li><a href="/company/outline/">会社概要</a></li>
                  <li><a href="/company/chart/">役員一覧と組織図</a></li>
                  <li><a href="/company/hub/">拠点一覧</a></li>
                  <li><a href="/company/group/">アイサングループ</a></li>
                  <li><a href="/company/history/">沿革</a></li>
                  <li><a href="/company/reconstruction/">災害復興への取り組み</a></li>
                  <li><a href="/company/behavioral/">行動指針</a></li>
                  <li><a href="/company/protection/">ソフトウェアライセンス製品の著作権保護方針</a></li>
                </ul>
              </div>
            </dd>
          </dl>
