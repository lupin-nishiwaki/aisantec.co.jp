    ...
    <div class="wrapper m_box_fixed">
      <div class="column_main">
        ...
        <section id="plan_motto" class="js_anim_scroll">
          ...
          <div class="row">
            <div>
              <img src="/asset/img/ir/management/plan/motto01.png" alt="知恵">
              <h3>知恵</h3>
              <p class="txt">それは無限の資産</p>
            </div>

            <div>
              <img src="/asset/img/ir/management/plan/motto02.png" alt="実行">
              <h3>実行</h3>
              <p class="txt">知恵は実行して実を結ぶ</p>
            </div>

            <div>
              <img src="/asset/img/ir/management/plan/motto03.png" alt="貢献">
              <h3>貢献</h3>
        ...
        <section id="plan_philosophy" class="js_anim_scroll">
          <h2 class="m_txt_h2">経営理念</h2>
          <p class="m_txt_body">知恵で地理空間情報のイノベーションを実行し社会資本の豊かな発展に貢献する。</p>
        </section>
        <!-- /#plan_philosophy -->

        <!-- #plan_guidelines -->
        <section id="plan_guidelines" class="js_anim_scroll">
          <h2 class="m_txt_h2">行動指針</h2>
