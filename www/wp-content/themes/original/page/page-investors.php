...
<div id="page_ir">
  ...
  <!-- #page-investors-mv -->
  <div id="page-investors-mv" class="wrapper m_box_fixed">
        ...
        <section id="challenge-story-cal" class="js_anim_scroll">
          <div class="frame-parent">
            <div class="parent">
              ...
              <div class="div2">社会を支える技術と情熱。<br class="pc-hide">その裏側にあるストーリーをご紹介します。</div>
            </div>
                ...
                <?php while ($the_query->have_posts()): ?>
                  ...
                  <a href="<?php the_permalink(); ?>" class="frame-container">
                    ...
                    <div class="frame-div">
                      ...
                      <div class="group">
                        <div class="div4"><div class="div5"><?php the_title(); ?></div></div>
            ...
            <a class="btn01 js_anim_scroll" href="/challenge-story/">
              <i></i>すべての記事をよむ
            </a>
          </div>
        </section>
