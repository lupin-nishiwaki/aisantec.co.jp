<?php
/**
 * Template Name: IR・投資家情報_株式について_株主還元
 */
  ...
  <div id="column2">
    <div class="wrapper m_box_fixed">
      <div class="column_main page-discroure">
        ...
        <?php
          $plan01_query = new WP_Query(
            array(
              'post_type'      => 'predict', //投稿タイプの指定
        ...
        <?php if ( $plan01_query->have_posts() ) : ?>
          <?php while ( $plan01_query->have_posts() ) : ?>
            ...
            <section id="reduction_information">
              <h2 class="m_txt_h2">配当情報</h2>

              <h3 class="m_txt_h3">配当予想</h3>

              <p class="lead"><?php the_field('year_month'); ?>の予想</p>
                ...
                <div class="inner">
                  <table>
                    <thead>
                      <tr>
                        <th class="item01"></th>
                        <th class="item02">第2四半期末</th>
                        <th class="item03">期末</th>
                        <th class="item04">年間配当金</th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="right">
                          <?php if( get_field('item_01') ): ?>
                            <?php echo number_format( get_field('item_01') ); ?>円
                          <?php else: ?>
                            -
                          <?php endif; ?>
                        </td>
                        ...
                        <td class="right">
                          <?php if( get_field('item_02') ): ?>
                            <?php echo number_format( get_field('item_02') ); ?>円(予定)
                          <?php else: ?>
                            -
                          <?php endif; ?>
                        </td>
                        ...
                        <td class="right">
                          <?php if( get_field('item_03') ): ?>
                            <?php echo number_format( get_field('item_03') ); ?>円(予定)
                          <?php else: ?>
                            -
                          <?php endif; ?>
                        </td>
