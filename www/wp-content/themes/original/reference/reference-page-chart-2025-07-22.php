        ...
        <section id="chart-list" class="js_anim_scroll">
          ...
          <dl class="item js_accordion">
            ...
            <dd class="item-dd">
              <div class="content">
                <picture>
                  <img src="/wp-content/uploads/2024/06/image_kato-1.jpg" alt="加藤 淳">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/uploads/2024/06/image_hosoi.jpg" alt="細井 幹広">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/uploads/2024/06/image_sato.jpg" alt="佐藤 直人">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/uploads/2024/06/image_soga.jpg" alt="曽我 泰典">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/asset/img/company/chart/chart-image06.jpg" alt="久野 誠一">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/uploads/2024/06/imgae_umeda.jpg" alt="梅田 靖">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/asset/img/company/chart/chart-image08.jpg" alt="野呂 充">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/asset/img/company/chart/chart-image10.jpg" alt="中垣 堅吾">
                </picture>
          ...
          <dl class="item js_accordion">
            ...
            <dd>
              <div class="content">
                <picture>
                  <img src="/wp-content/uploads/2024/06/image_yamada.jpg" alt="山田 麻登">
                </picture>
        ...
        <section id="chart-skill" class="js_anim_scroll">
          ...
          <div class="table-cover m_box_table">
            ...
            <div class="inner-wrap">
              <div class="inner">
                <picture>
                  <img src="/asset/img/company/chart/chart-skill-image01.png" alt="役員のスキルについて">
                </picture>
              </div>
            </div>
          ...
          <div class="table-cover m_box_table slill-detail">
            ...
            <div class="inner">
              <picture>
                <img src="/asset/img/company/chart/chart-skill-image01-2.png" alt="スキル詳細" class="pc">
                <img src="/asset/img/company/chart/chart-skill-image01-2-sp.png" alt="スキル詳細" class="sp">
              </picture>
            </div>
        ...
        <section id="chart-organization" class="js_anim_scroll">
          ...
          <div class="table-cover m_box_table">
            ...
            <div class="inner-wrap">
              <div class="inner">
                <picture>
                  <img src="/asset/img/company/chart/chart-skill-image04.png?2025-07-22" alt="">
                </picture>
              </div>
            </div>
